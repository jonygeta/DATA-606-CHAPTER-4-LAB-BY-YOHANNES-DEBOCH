...
hist(samp)
```
The sampling distribution is normal. Typical size within the sample is the house size is the mode of the house size  1774. 
Typical to mean is the house size centered near the mean house size value 1450.

2.  Would you expect another student's distribution to be identical to yours? 
Would you expect it to be similar? Why or why not?
Answer: I don't expect another student's distribution to be identical to mine. I expect it to be similar because we're both drawing sample from the same population.
...
1. The sample observations need to be independent.
2. Number of samples need to be greater than 30.
3. The distribution should be approximately normal.

## Confidence levels

4.  What does "95% confidence" mean? If you're not sure, see Section 4.2.2.
Answer: Out of 100 sample means 95 times it will lie within the 95% confidence interval.
...
Answer:  Yes. It capture the true average size of houses in Ames. 
My neighbor's interval capture this value I'm confident 95%.
...
population mean.
Answer: I would expect 95% time the student's intervals will computer the actual mean due to 95% confidence interval.
...
94/100
```
 0.94 of of samples captures the true mean. It's not equal to the confidence interval.Due to small sample it's not equal to confidence interval.
-   Pick a confidence level of your choosing, provided it is not 95%. What is 
    the appropriate critical value?
Answer:
For 90% confidence interval the critical value is 1.65.
...
```
 ...
 0.86 of of samples captures the true mean. It's not equal to the 90% confidence interval.Due to small sample it's not equal to confidence interval.